	...
	<body>
				...
				<div class="row align-items-center justify-content-between">
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							...
							<li class="menu-has-children"><a href="">Health</a>
								<ul>
									<li><a href="fitness.html">Fitness</a></li>
									<li><a href="food_and_diet.html">Food and Diet</a></li>
					...
					<div class="row small-gutters">
						...
						<div class="col-lg-4 top-post-right">
							<div class="single-top-post">
								...
								<div class="top-post-details">
									<ul class="tags">
										<li><a href="food_and_diet.html">Health</a></li>
									</ul>
									<a href="image-post.html">
		...
		<footer class="footer-area">
				<div class="footer-logo" >
					<center>						
							<img width="450" height="150" src="img/footer_logo.png"> </div>
					</center>
					<center><p>Copyright © 2019 Magazine . All Rights Reserved . Design by ONE </p></center>	
